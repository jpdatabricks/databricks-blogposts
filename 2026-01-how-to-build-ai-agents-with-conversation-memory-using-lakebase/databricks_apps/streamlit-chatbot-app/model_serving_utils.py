...
def _query_endpoint(
    endpoint_name: str, messages: list[dict[str, str]], max_tokens, thread_id
) -> list[dict[str, str]]:
...
def query_endpoint(endpoint_name, messages, max_tokens, thread_id):
    """
    ...
    ."""
    return _query_endpoint(endpoint_name, messages, max_tokens, thread_id)[-1]
