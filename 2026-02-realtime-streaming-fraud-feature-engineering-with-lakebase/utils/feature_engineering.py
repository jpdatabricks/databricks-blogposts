...
def get_fraud_detection_output_schema():
    ...
    **Note**: This schema only includes fields output by the stateful processor.
    ...
    return StructType([
        ...
        # Stateless features (passed through from AdvancedFeatureEngineering)
        StructField("month", IntegerType(), True),
        StructField("hour", IntegerType(), True),
        StructField("day_of_week", IntegerType(), True),
        StructField("is_business_hour", IntegerType(), True),
        ...
        StructField("is_round_amount", IntegerType(), True),
        StructField("is_exact_amount", IntegerType(), True),
        StructField("merchant_risk_score", DoubleType(), True),
        StructField("is_private_ip", IntegerType(), True),
